 ...
 * on 2018/11/14
 */
public class SearchFancyBehavior extends CoordinatorLayout.Behavior<NestedScrollView> {
    ...
    public SearchFancyBehavior(Context context, AttributeSet attrs) {
        super(context, attrs);
...
//      //开始滑动时的判断
//        //此处千年老坑
//        //onStartNestedScroll过时方法是没有type这一项，当NestedScrollView滑到顶部是不会下滑的，需要加上type判断，或使用过时方法
...
//    }
    ...
    public boolean onNestedPreFling(@NonNull CoordinatorLayout coordinatorLayout, @NonNull NestedScrollView child, @NonNull View target, float velocityX, float velocityY) {
        Log.i(TAG, "onStopNestedScroll: " + velocityY);
